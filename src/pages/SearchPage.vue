<template>
  <div class="container" style="max-width: 1980px; width: 100%">
    ...
    <div v-if="flag">
    <div style="width: 30%; float: left; margin-top: 4%;">
    <Search1 @res="showResult" :selected="selected" :foodName="foodName" :filtercuisines="filtercuisines" :filterdiets="filterdiets" :filterintolerances="filterintolerances"/>
</div>
...
<b-container>
  ...
  <div v-else style="margin-top: 4%;margin-left: 20%;">
    <Search1 @res="showResult" :selected="selected" :foodName="foodName" :filtercuisines="filtercuisines" :filterdiets="filterdiets" :filterintolerances="filterintolerances"/>
  </div>
    </div>
</template>
